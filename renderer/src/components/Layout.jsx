...
function Layout() {
  ...
  return (
    <div
      className={`${
        isSidebarOpen ? "lg:grid-cols-17" : "lg:grid-cols-22"
      } sm:grid-cols-1 w-dvw h-dvh bg-dark grid relative`}
    >
      <div
        className={`${
          isSidebarOpen ? "col-span-2" : "col-span-1"
        } hidden sm:block transition-all duration-300 ease-in-out relative`}
      >
        <div
          className={`p-2 h-full w-full flex flex-col  border-r separator ${
          ...
          <div className="flex flex-col h-full overflow-y-auto overflow-x-hidden flex-grow pt-2 justify-between">
            <div className="flex flex-col space-y-1 mx-1 lg:mt-1">
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex flex-row items-center justify-center ${
                    ...
                    isActive
                      ? "bg-primary-50 shadow-sm text-amber-300 font-bold"
              ...
              >
                ...
                <span
                  className={`ml-0 lg:ml-2 text-sm tracking-wide truncate capitalize ${
                    isSidebarOpen ? "hidden sm:hidden lg:block" : "hidden"
                  }`}
                >
                  Home
                </span>
      ...
      <div
        className={`${
          isSidebarOpen ? "col-span-15" : "col-span-21"
